...
const (
	// CustomerIDPrefix müşteri kimliklerinin önekidir.
	CustomerIDPrefix = "cust_"
	// CustomerGroupIDPrefix müşteri grubu kimliklerinin önekidir.
	CustomerGroupIDPrefix = "custgrp_"
	// AddressIDPrefix müşteri adresi kimliklerinin önekidir.
...
// taşıması demektir.
//
// Aynı üretici pricing ve inventory modüllerinde de bulunur; modül izolasyonu
// gereği o paketler import EDİLMEZ (Prensip 2.4), üretici burada tekrar edilir.
...
// NewAddressID yeni bir müşteri adresi kimliği üretir.
