...
//
// It is called from the provider's OWN package for the reason the store-credit
...
// touch it.
func newForCompliance(t *testing.T) *loyaltypoints.Provider {
	t.Helper()

	return loyaltypoints.New(nil, slog.New(slog.DiscardHandler))
}
