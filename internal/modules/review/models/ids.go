...
// ReviewIDPrefix is the prefix of review identifiers. A prefix makes which
// entity an identifier belongs to readable without looking at a table.
...
// NewReviewID produces a new review identifier.
func NewReviewID() string { return newID(ReviewIDPrefix, time.Now()) }
