...
|---|---|
| [`docs/adr/README.md`](./docs/adr/README.md) | The INDEX of the decisions: ninety-three records, each with its decision in one sentence. In case of conflict, **the ADR wins** |
