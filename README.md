...
| Belge | Neyi cevaplar |
|---|---|
| [`docs/adr/README.md`](./docs/adr/README.md) | Kararların İNDEKSİ: seksen dört kayıt, her biri tek cümlelik kararıyla. Plan ile çelişirse **ADR geçerlidir** |
...
| [`docs/known-limits.md`](./docs/known-limits.md) | Bilinen sınırlar: yirmi altı madde, beş küme — kimlik ve yetki, satış kanalı kapsamı, kategori ağacı, kurulum ve işletim, değişmezlerin sınırı |
