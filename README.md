...
| [0026](docs/adr/0026-the-published-surface-is-fourteen-packages.md) | Yayımlanmış yüzey | Yayımlanan ağaç `core/`tur ve **on beş paket** taşır; aralarında hiçbir commerce modeli yoktur. (Dosya adı "fourteen" der: sayı ADR yazıldığı gündeki sayıdır, `core/personaldata` 2026-09-06'da eklendi — ADR 0026'nın kendi ek notuna bakınız. Dosya YENİDEN ADLANDIRILAMAZ, belge referans denetimi bu ADR'yi yoluyla çözer.) |
