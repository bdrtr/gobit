...
// migration side see core/db MigrationsTable.
package link
...
// core/db: both prevent an unvalidated string from becoming an SQL
...
// table name unvalidated (the same reasoning as core/db
// MigrationsTable).
