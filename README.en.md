...
|---|---|
| [`docs/adr/README.md`](./docs/adr/README.md) | The INDEX of the decisions: seventy-one records, each with its decision in one sentence. In case of conflict with the plan, **the ADR wins** |
