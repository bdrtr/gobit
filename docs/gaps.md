...
is: of the seventeen open rows, eight carry a recorded relation and NINE carry
none. Only three ordering facts are written down anywhere in this file, and they
are worth separating out:

- **A2 is the root.** It is the only row two others name as upstream: A4's
...
- **A7 and A12 are a PAIR and not a sequence.** Each one's answer is an input to
